...
<link rel="stylesheet" href="css menu/my.css">
 <link href="css menu/mydcstyle.css" rel="stylesheet" type="text/css" />
                            ...
                            <div id='cssmenu'>
                                ...
                                <li style="float:right;"><a class="w3-blue" id="MenuContent_h1other" href="#">My Acount</a>   
                                    <ul>
                                        ...
                                        <li>
                                            <a id="MenuContent_h1ugchumanresource" href="Index">LogOut</a> 
                                        </li>
                                    </ul>
                                </li>
