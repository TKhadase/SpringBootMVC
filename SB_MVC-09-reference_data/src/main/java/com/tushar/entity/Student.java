...
@NoArgsConstructor
@Entity
@Table(name="REFDATA_STUDENT_DETAILS")
@SQLDelete(sql = "UPDATE  REFDATA_STUDENT_DETAILS  SET ISDELETED='Y' WHERE ENROLLID=?")
@Where(clause = "ISDELETED <> 'Y' ")
public class Student implements Serializable {

	@Id
	@SequenceGenerator(name = "ENRLOLL_GEN", sequenceName = "ROLL_SEQ_REFDATA",initialValue = 1, allocationSize = 1)
	...
	public String toString() {
		return "Student [ENROLLID=" + ENROLLID + ", ROLLID=" + ROLLID + ", fname=" + fname + ", mname=" + mname
				...
				+ ", gender=" + gender + ", ISDELETED=" + ISDELETED + ", vflag=" + vflag + ", newsletter=" + newsletter
				+ ", terms=" + terms + "]";
	}
